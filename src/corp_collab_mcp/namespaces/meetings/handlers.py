...
@mcp.tool(name="meetings.create_meeting", description="Create a new calendar event/meeting.")
...
@mcp.tool(name="meetings.cancel_meeting", description="Cancel an existing meeting.")
...
@mcp.tool(name="meetings.list_meetings", description="List meetings for a user within a time range.")
...
@mcp.tool(name="meetings.find_available_slots", description="Find available time slots for meeting participants.")
...
@mcp.tool(name="meetings.get_availability", description="Get availability status for a list of users.")
